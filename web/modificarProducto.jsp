<%-- 
    ...
    Created on : 09-abr-2019, 13:23:24
    Author     : Sergio
--%>
        ...
        <div class="container">
            <div class="row" style="margin-top: 25px;margin-bottom: 56px;">
                <div class="col-md-6">
                    ...
                    <h1 style="margin-top: 0px;">Modificar 'NombreProducto'</h1>
                    <!-- End: NombreProducto -->
                </div>
    ...
    <div>
        <div class="container">
            <div class="row" style="margin-bottom: 70px;">
                <div class="col-md-6">
                    <!-- Start: ImagenProducto --><img src="assets/img/61yI7vWa83L._SL1000_.jpg" style="width: 380px;margin-top: 0px;margin-left: 48px;">
                    <!-- End: ImagenProducto -->
                ...
                <div class="col-md-6" style="margin: 0px;">
                    <div style="margin-bottom: 0px;">
                        <h4>Nombre del Producto:</h4><input class="border rounded border-dark shadow-sm" type="text" style="width: 475px;height: 43px;margin-top: 5px;"></div>
                    <div style="margin-bottom: 47;margin-top: 30px;">
                        <h4>Descripción del producto:</h4><textarea class="border rounded border-dark form-control-lg" style="height: 200px;width: 475px;margin-top: 5px;"></textarea></div>
                    <div style="margin-bottom: 47;margin-top: 30px;">
                        <h4>Precio (€):</h4><input class="border rounded border-dark shadow-sm" type="text" style="width: 364px;height: 43px;margin-top: 5px;"></div>
        ...
        <div class="container">
            <div class="row" style="margin-top: -15px;margin-bottom: 56px;">
                ...
                <div class="col-md-6 d-xl-flex justify-content-xl-end" style="margin-top: 39px;">
                    <!-- Start: eliminarDeLaCestaButton --><button class="btn btn-primary border rounded" type="button" style="margin-right: 22px;margin-left: 0px;width: 178px;background-color: rgb(169,41,41);height: 43px;margin-top: 8px;padding: 0px;"><i class="icon ion-android-delete float-left d-xl-flex justify-content-xl-end" style="padding-right: 9px;margin-right: -12px;margin-left: 2px;margin-top: 4px;width: 34px;"></i>Eliminar Producto</button>
                    <!-- End: eliminarDeLaCestaButton -->
                    <!-- Start: eliminarDeLaCestaButton --><button class="btn btn-primary border rounded" type="button" style="margin-right: 0px;margin-left: 0px;width: 178px;background-color: rgb(85,85,85);height: 43px;margin-top: 8px;padding: 0px;"><i class="fas fa-chevron-circle-down float-left d-xl-flex justify-content-xl-end" style="padding-right: 9px;margin-right: -10px;margin-left: 4px;margin-top: 5px;width: 34px;"></i>Confirmar datos</button>
                    <!-- End: eliminarDeLaCestaButton -->
                </div>
