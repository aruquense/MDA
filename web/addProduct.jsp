        ...
        <div class="container">
            <div class="row" style="margin-top: 25px;margin-bottom: 56px;">
                ...
                <div class="col-md-6 d-xl-flex justify-content-xl-end">
                    <!-- Start: eliminarDeLaCestaButton --><button class="btn btn-primary border rounded" type="button" style="margin-right: 0px;margin-left: 0px;width: 178px;background-color: rgb(85,85,85);height: 43px;margin-top: 8px;padding: 0px;"><i class="fas fa-chevron-circle-down float-left d-xl-flex justify-content-xl-end" style="padding-right: 9px;margin-right: -14px;margin-left: 9px;margin-top: 5px;width: 34px;"></i>Crear producto</button>
