            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 327px;font-size: 20px;">Restricciones de envío</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Restricción</td>
                        <td>Perfil Vendedor</td>
                        <td style="width: 360px;"><button class="btn btn-primary border rounded" type="button" style="margin-right: -190px;margin-left: 0px;width: 193px;background-color: rgb(169,41,41);height: 50px;"><i class="material-icons float-left" style="padding-right: 9px;margin-right: -11px;margin-left: 4px;">shopping_cart</i>Añadir a la cesta</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
